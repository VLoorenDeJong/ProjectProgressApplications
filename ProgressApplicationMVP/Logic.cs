...
namespace ProgressApplicationMVP
{
    ...
    {
        // ToDo Check for differences with CSV Config
        //public static (IDataAccess database, string mainGoal) GetProgressDbConfig(IConfiguration config, IDataAccess db, string pageName)
        //{
