...
namespace PresentationWebFront
{
    public static class Logic
    {
        public static (IDataAccess database, string mainGoal) GetDbConfig(IConfiguration config, IDataAccess db, string pageName)
        {
            ...
            string projectFileFolderPath = "";
            string timeUnitFileFolderPath = "";
            ...
            if (connectionType == "CSV" && mainGoal != "!!!! DEVELOPMENT ENVIRONMENT !!!!")
            {
                ...
                databseFolderPath = GetCSVFolderLocation("DatabaseFolderPath", currentDirectory, config);
                ...
                //projectFilePath = $"{ currentDirectory }{ databseFolderPath }{ mainGoal }{ environment }ProjectsFile.CSV";
                //timeUnitFilePath = $"{ currentDirectory }{ databseFolderPath }{ mainGoal }{ environment }TimeUnitsFile.CSV";

                projectPicturesFolderPath = GetCSVFolderLocation("ProjectPicturesFolderPath", currentDirectory, config);
                filesFolderPath = GetCSVFolderLocation("FilesFolderPath", currentDirectory, config);
                picturesFolderPath = GetCSVFolderLocation("PicturesFolder", currentDirectory, config);
                randomItemsFolderPath = GetCSVFolderLocation("RandomItemsFolder", currentDirectory, config);
            ...
            if (connectionType == "CSV" && mainGoal == "!!!! DEVELOPMENT ENVIRONMENT !!!!")
            {
                ...
                projectPicturesFolderPath = GetCSVDevelopmentFolderLocation("ProjectPicturesFolderPath", currentDirectory, config);
                filesFolderPath = GetCSVDevelopmentFolderLocation("FilesFolderPath", currentDirectory, config);
                picturesFolderPath = GetCSVDevelopmentFolderLocation("PicturesFolder", currentDirectory, config);
                randomItemsFolderPath = GetCSVDevelopmentFolderLocation("RandomItemsFolder", currentDirectory, config);
        ...
        private static string GetCSVFolderLocation(string value, string currentDirectory, IConfiguration config)
        {
            ...
            string location = $"{ currentDirectory }{ placementFolderPath }{ finalFolderPath }";

            return location;

        }
        private static string GetCSVDevelopmentFolderLocation(string value, string currentDirectory, IConfiguration config)
        {
            string mainSection = "DataAccess";
            string subSection = "CSV";
        ...
        public static (string ProjectPictureFilePath, bool ShowPicture) SetUpPictureShowing(string title)
        {
            bool showPicture = false;

            string currentDirectory = Directory.GetCurrentDirectory();
            string projectPictureFolder = @"\wwwroot\ProjectPhotos\";
            string projectPhotoName = $"{ title }.jpg";

            string fullFilePath = currentDirectory + projectPictureFolder + projectPhotoName;

            showPicture = DecideToShowPicture(fullFilePath);

            // Do not put in a full file path start from rootwww 
            string outputFilepath = @$"ProjectPhotos\{ title }.jpg"; ;
